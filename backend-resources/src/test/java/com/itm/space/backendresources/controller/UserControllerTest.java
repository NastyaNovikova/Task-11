...
@WithMockUser(username = "nastya", password = "1111", authorities = "ROLE_MODERATOR")
public class UserControllerTest extends BaseIntegrationTest {
    ...
    void setUp() {
        ...
        userRequest = new UserRequest("nastya", "nastya@yandex.ru", "1111", "Nastya", "Nov");
    }
    ...
    void testHello() throws Exception {
        ...
        assertEquals("nastya", responseContent);
    }

    @Test
    void create() {
        UserRequest userRequest = new UserRequest("nastya", "nastya@mail.com", "1111", "Nastya", "Nov");
        try {
    ...
    void getUserById() {
        try {
            ...
            assertEquals("Nastya", userResponse.getFirstName());
